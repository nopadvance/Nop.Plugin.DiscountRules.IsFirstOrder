...
using Nop.Plugin.DiscountRules.IsFirstOrder.Models;
...
namespace Nop.Plugin.DiscountRules.IsFirstOrder.Controllers
{
	[AuthorizeAdmin]
    ...
    public class DiscountRulesIsFirstOrderController : BasePluginController
    {
        ...
        public DiscountRulesIsFirstOrderController(ICustomerService customerService,
        ...
        public IActionResult Configure(int discountId, int? discountRequirementId, bool isApplied)
        {
            ...
            _settingService.SetSetting(string.Format(DiscountRequirementDefaults.SettingsKey, discountRequirement.Id), isApplied);
